                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="Register.html"><button type="button" class="btn btn-primary">Add New</button></a>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-hover">
                                    ...
                                    <% for(User u : UserDAO.listUsers()){ %>
                                        <tr>
                                            ...
                                            <td><%=u.getEmailId() %></td>
											<td><%=u.getPhoneNo() %></td>
											<td><a href="UserController?id=<%=u.getUserId() %>&action=edit" class="btn btn-link">Edit</a></td>
											<td><% if(u.getStatus()!=1) {%><button type="button" class="btn btn-warning btn-circle"><i class="fa fa-times"></i></button>
